    ...
    <div class="search-table">
        <div class="search-table-filter">
            ...
            <el-radio-group v-model="filterCar" @change="onFilterCar">
                <el-radio style="color: white;" label="1">显示全部车辆</el-radio>
                <el-radio style="color: white;" label="2">只显示表中车辆</el-radio>
            </el-radio-group>
        </div>
        <el-table :data="carData.slice((currentPage-1)*pageSize,currentPage*pageSize)" size='small' border
            ...
            <el-table-column label="申请事由" width="90" prop="APPLY_REASON"></el-table-column> -->
            <el-table-column label="操作" width="160">
                <template slot-scope="scope">
                    <el-button @click="highlightRow(scope.row)" type="text" size="small"
                        icon="el-icon-location-information" title="定位">定位
                    </el-button>
...
<script>
    export default {
        ...
        mounted() {
            ...
            scope.$listener.$on('searchTable', function (cardata) {
